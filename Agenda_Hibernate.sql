...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-11-2013 a las 17:31:56
...
--
-- Base de datos: `daw_pruebas`
--
CREATE DATABASE IF NOT EXISTS `daw_pruebas` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `daw_pruebas`;
...
(2, 'Noticia de roma', 'claro que si es mi noticia que pasa aquÃ­ que no puedo poner mi noticia, o que ehhh', '2013-10-09 01:32:54', 'roma'),
